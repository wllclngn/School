...
int xinu_doscan_sim_redirect(char *fmt, va_list ap, xinu_doscan_getc_func_t getc_func, xinu_doscan_ungetc_func_t ungetc_func, int getc_arg, int ungetc_arg);
...
/* XINU structure definitions - needed for compatibility */
struct uart_csreg;
struct ttycblk;
