...
class XinuConfig:
    ...
    def __init__(self, project_dir="."):
        ...
        self.system_dir = os.path.join(self.project_dir, "system")
        self.device_dir = os.path.join(self.project_dir, "device")
        self.shell_dir = os.path.join(self.project_dir, "shell")
        self.libxc_dir = os.path.join(self.project_dir, "lib/libxc")
        self.compile_dir = os.path.join(self.project_dir, "compile")
        
        # Output paths
        self.output_dir = os.path.join(self.project_dir, "sim_output")
        self.obj_dir = os.path.join(self.output_dir, "obj")
        
        # Generated files
        self.stddefs_h = os.path.join(self.project_dir, "xinu_stddefs.h")
        self.includes_h = os.path.join(self.project_dir, "xinu_includes.h")
        self.sim_decls_h = os.path.join(self.project_dir, "xinu_sim_declarations.h")
        self.sim_helper_c = os.path.join(self.project_dir, "xinu_simulation.c")
        self.xinu_core_c = os.path.join(self.project_dir, "xinu_core.c")
